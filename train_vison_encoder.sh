...
#     --output_dir /data/wangzexin/saves/qwen_25_vl_sft_vision_tower \
#     --plot_loss True \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 accelerate launch  src/train.py \
    ...
    --stage sft \
    --do_train True \
    --model_name_or_path /data/wangzexin/saves/qwen_25_vl_sft_vision_tower \
    --trust_remote_code True \
    --flash_attn fa2 \
    --finetuning_type full \
    --template qwen2_vl \
    ...
    --warmup_ratio 0.1 \
    --neftune_noise_alpha 0 \
    --output_dir /data/wangzexin/saves/qwen_25_vl_sft_all_after_sft_vision_tower \
    --plot_loss True \
    --overwrite_output_dir True \
    --ddp_timeout 180000000 \
    --bf16 True \
